...
class MusicPlayerApp:
    def __init__(self, root):
        ...
        self.label = Label(root, text="DANIFATURRAHMAN 220511045")
        self.label.pack(pady=20, padx=5)

        self.label = Label(root, text="Demi Levato : HeartAttack")
        ...
        self.photo_pause = PhotoImage(file="PERTEMUAN6/play.png").subsample(16)
        self.photo_resume = PhotoImage(file="PERTEMUAN6/pause.png").subsample(16)
    ...
    def play_music(self):
        ...
        file_path = os.path.join(os.getcwd(), "PERTEMUAN6/HeartAttack.mp3")
